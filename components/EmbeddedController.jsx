    ...
    return (
        <group ref={boardRef}>
            ...
            <Box args={[6.5, 0.1, 4.2]} position={[0, 0, 0]}>
                {isLowQuality ? <meshStandardMaterial color="#064e3b" roughness={0.7} /> : <meshPhysicalMaterial color="#064e3b" metalness={0.3} roughness={0.7} clearcoat={0.5} clearcoatRoughness={0.2} />}
            </Box>
            ...
            <group position={[-2.8, 0.15, -1.8]}>
                ...
                {Array.from({ length: isLowQuality ? 5 : 20 }).map((_, i) => (
                    <group key={i} position={[i * (isLowQuality ? 0.8 : 0.2) + 0.2, 0.2, 0]}>
